...
![图片](BFS算法框架套路详解.assets/640-1647491173563.jpg)

怎么套到 BFS 的框架里呢？首先明确一下起点`start`和终点`target`是什么，怎么判断到达了终点？

**显然起点就是root根节点，终点就是最靠近根节点的那个「叶子节点」嘛**，叶子节点就是两个子节点都是`null`的节点：
...
![图片](BFS算法框架套路详解.assets/640-1647491173558.jpg)
...
![图片](BFS算法框架套路详解.assets/640-1647491173562.jpg)
...
另外的一个技巧点就是 **while 循环的最后交换q1和q2的内容**，所以只要默认扩散`q1`就相当于轮流扩散`q1`和`q2`。
