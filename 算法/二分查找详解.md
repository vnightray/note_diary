...
**2、为什么****left = mid + 1，right = mid - 1？我看有的代码是right = mid或者left = mid，没有这些加加减减，到底怎么回事，怎么判断**？
...
![图片](二分查找详解.assets/640-1647489954493.jpg)
...
![图片](二分查找详解.assets/640-1647489954494.jpg)
...
**2、为什么最后返回****left - 1而不像左侧边界的函数，返回left？而且我觉得这里既然是搜索右侧边界，应该返回right才对**。
...
**3、为什么没有返回 -1 的操作？****如果****nums中不存在target这个值，怎么办？**
